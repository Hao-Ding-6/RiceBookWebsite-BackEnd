...
passport.use(new GoogleStrategy(config, (accessToken, refreshToken, profile, done) => {
    ...
    User.findOne({'authorization.Google': profile.name.givenName + profile.name.familyName}, (error, user) => {
       if (user) {
           ...
           const emailAddress = "dingh.loong@gmail.com";
           const birthday = "1996-04-11";
           const phoneNumber = "832-641-9473";
           const zipCode = "77030";
           const headline = "Hi I'm Hao, this is my Google account.";
           const following = ["HIRI"];
...
const GoogleLogin = (req, res) => {
    ...
    res.redirect("https://ricebook-hd25.surge.sh/#/main")
};

/** if third party authentication fails, return auth page **/
const fail = (req, res) => {
    res.redirect("https://ricebook-hd25.surge.sh/#/auth")
};
